...
namespace NIC.SBCPlatform.SharedModules.LookupManagement.Users
{
    ...
    public class AppUser : FullAuditedAggregateRoot<Guid>
    {
         ...
         *
         * 1. Update LookupManagementDbContext.OnModelCreating
         * to configure the mapping for your new property
         * 2. Update LookupManagementEfCoreEntityExtensionMappings to extend the IdentityUser entity
